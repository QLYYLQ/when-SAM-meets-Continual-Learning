...
from model.encoder.image_encoder.vit import build_vit,ViT
from model.decoder.mask_decoder.mask_decoderHQ import MaskDecoder,Mask_Decoder_HQ
from model.encoder.prompt_encoder.prompt_encoder import PromptEncoder
...
class Sam(nn.Module):
    ...
    def __init__(
        ...
        mask_decoder: Union[MaskDecoder,Mask_Decoder_HQ],
            pixel_mean=None,
            pixel_std=None,
    ) -> None:
        """
