...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = MLPBlock(
            embedding_dim=dim, mlp_dim=mlp_hidden_dim, drop=drop
        )
...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        # prepare down_sample list
        down_sample_list = [PatchMerging for i in range(self.num_layers)]
        down_sample_list[-1] = None
        num_features = [int(embed_dim * 2 ** i) for i in range(self.num_layers)]
        if self.dilation:
            down_sample_list[-2] = None
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(
                ...
                downsample=down_sample_list[i_layer],
